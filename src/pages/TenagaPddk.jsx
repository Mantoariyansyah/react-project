...
import guru1 from "../img/guru1.png";
import guru2 from "../img/guru2.png";
import guru3 from "../img/guru3.png";
...
// Komponen reusable untuk card guru
function CardGuru({ img }) {
  return (
