    ...
    <div>
      ...
      <div className="flex px-20 gap-10 pb-20 pt-16">
        ...
        <div className="w-1/2">
          ...
          <p className="text-md mt-2 leading-relaxed text-justify">
            Selamat datang di website SMAS Kristen Bethel Jakarta. Website ini hadir sebagai media
            informasi dan komunikasi untuk seluruh warga sekolah dan masyarakat umum. Dengan
            mengikuti perkembangan teknologi di era digital, kami berharap website ini dapat
            memudahkan akses informasi mengenai profil, kegiatan, dan prestasi SMAS Kristen Bethel
            Jakarta. Semoga website ini menjadi sarana yang bermanfaat dalam mendukung pendidikan
            dan pelayanan kami kepada masyarakat. Tuhan memberkati.
          </p>
        </div>
      </div>
      ...
      <div className="pb-20 px-20 pt-16">
        <h1 className="text-2xl font-bold mb-6 text-center pb-6 text-[#101524]">
          Proses Pendaftaran Siswa Baru <br />
          <span className="relative inline-block after:absolute after:left-28 after:bottom-[-12px] after:h-[4px] after:w-[6ch] after:bg-[#FEF600] after:rounded-full">
            SMAS Kristen Bethel Jakarta
          </span>
        </h1>
      ...
      {/* content6 Berita dari API */}
      <div className="pb-20 px-20">
        <h1 className="text-2xl font-bold mb-6 text-center pb-6 text-[#101524]">
          Berita &{" "}
          <span className="relative inline-block after:absolute after:left-6 after:bottom-[-12px] after:h-[4px] after:w-[6ch] after:bg-[#FEF600] after:rounded-full">
            Informasi
          </span>
        </h1>
        ...
        <div className="flex items-center justify-center space-x-10 text-[#101524]">
          {berita.length > 0 ? (
            ...
            <p className="text-center text-gray-500">Tidak ada berita tersedia</p>
          )}
        </div>
      ...
      <div className="pb-20 flex items-center justify-center px-20">
        <div>
          <h1 className="text-2xl font-bold mb-6 text-[#101524]">
            SMAS{" "}
            <span className="relative inline-block after:absolute after:left-0 after:bottom-[-12px] after:h-[4px] after:w-[17.7ch] after:bg-[#FEF600] after:rounded-full">
